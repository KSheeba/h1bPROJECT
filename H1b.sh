...
while [ opt != '' ]
    ...
    if [[ $opt = "" ]]; then 
        ...
        hadoop jar MR1a.jar MR1a /user/hive/warehouse/h1b.db/h1bfinal /user/hduser/hadoop/MR1aoutput;
        hadoop fs -cat /user/hduser/hadoop/MR1aoutput/p*;
        show_menu;
        ;;

        1b) clear;
        option_picked "Find top 5 job titles who are having highest avg growth in applications.";
        hadoop jar MR1b.jar MR1b /user/hive/warehouse/h1b.db/h1b_final /user/hduser/hadoop/MR1boutput;
        hadoop fs -cat /user/hduser/hadoop/MR1boutput/p*;
        show_menu;
        ;;
	...
	3) clear;
        ...
        hadoop jar MR3.jar MR3 /user/hive/warehouse/h1b.db/h1b_final /user/hduser/hadoop/MR3output;
        hadoop fs -cat /user/hduser/hadoop/MR3output/p*;
        show_menu;
        ;;
         4) clear;
          option_picked "Which top 5 employers file the most petitions each year? - Case Status - ALL";
          hadoop jar MR4.jar MR4 /user/hive/warehouse/h1b.db/h1b_final /user/hduser/hadoop/MR4output;
          hadoop fs -cat /user/hduser/hadoop/MR4output/p*;
          show_menu;
          ;;        
      ...
      hive -f hive6.txt;
           ...
           option_picked "Find the percentage and the count of each case status on total applications for each year. Create a line graph      depicting the pattern of All the cases over the period of time.";
            ...
            hadoop jar MR7.jar MR7 /user/hive/warehouse/h1b.db/h1b_final /user/hduser/hadoop/MR7output;
            hadoop fs -cat /user/hduser/hadoop/MR7output/p*;
             show_menu;
                ;;
           7b) clear;
            option_picked "Create a bar graph to depict the number of applications for each year";
